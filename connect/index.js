...
const { friend, forks, team } = require('../lib/IniLog');
...
console.log(color(`${Spc3}< ================================================== >`, 'cyan'))
  ...
  client.ev.on("messages.upsert", async (chatUpdate) => {
    ...
    try {
      ...
      require("./agam")(client, m, chatUpdate, store);
    } catch (err) {
      console.log(err);
    }
  });
